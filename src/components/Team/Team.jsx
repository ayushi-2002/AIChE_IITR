                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box16">
                                ...
                                <div class="box-content">
                                    ...
                                    <ul class="social">
                                        <li><a href="https://www.linkedin.com/in/vimal-singh-3b83644/"><i class="fa fa-linkedin"></i></a></li>
                                        <li><a href={"mailto:" + faculty_coordinator.mail}><i class="fa fa-envelope"></i></a></li>
                                    </ul>
                                </div>
                        </div>
                        </div>
